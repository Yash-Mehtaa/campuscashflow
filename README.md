...
>  **Download (macOS .dmg):** [BudgetInsight v1.0](https://github.com/Yash-Mehtaa/budgetinsight/releases/tag/v1.0)
...
That frustration sparked **BudgetInsight** : a lightweight Java desktop app that turns your entire budget into one clean, real-time number: *your remaining balance for the month.*  
